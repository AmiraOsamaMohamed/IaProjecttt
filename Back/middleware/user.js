...
contactUs=async (req, res) => {
  try {
    ...
    // 4- INSERT job OBJECT INTO DATABASE
    await Insert.insert(Obj,"contactus");
...
router.router.get("/show-specific-job/:id",userObj.show_specific_job)
...
router.router.put('/update-job-acceptance/:id', admin,found,
  body("acceptance").isBoolean().withMessage("please enter a valid job acceptance"),userObj.update_job_acceptance)
